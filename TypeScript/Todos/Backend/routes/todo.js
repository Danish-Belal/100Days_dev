...
var index_1 = require("../middelware/index");
var db_1 = require("../db");
...
router.get('/todos', index_1.authenticateJWT, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db_1.Todo.find({ userId: userId })];
            case 2:
                todos = _a.sent();
